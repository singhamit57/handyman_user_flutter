    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          8.height,
          if (widget.bookingDetail.status == BookingStatusKeys.complete && (widget.bookingDetail.paymentStatus == SERVICE_PAYMENT_STATUS_PAID || widget.bookingDetail.isFreeService || widget.bookingDetail.paymentStatus == PENDING_BY_ADMIN))
            TextButton(
              onPressed: () {
